/* Auto-generated unified quizzes.js — keys derived from filenames (module1..module52) */

const QUIZ_DATA = {
  "module1": [
        {
            id: 'm1-q1', 
            question: 'Qual das seguintes opções é um exemplo de comunicação não-verbal?',
            options: {
                a: 'Um e-mail enviado para a equipe.',
                b: 'Uma placa de trânsito de "Pare".',
                c: 'Uma conversa por telefone.',
                d: 'Um relatório escrito.'
            },
            answer: 'b',
            explanation: 'A comunicação não-verbal dispensa o uso de frases, concentrando-se em formas corporais e visuais, como placas.'
        },
        {
            id: 'm1-q2',
            question: 'Segundo o texto, a comunicação é fundamental para:',
            options: {
                a: 'Apenas interações digitais.',
                b: 'Apenas para o ambiente de trabalho.',
                c: 'Criar conexões e fortalecer relações humanas e culturais.',
                d: 'Apenas para transmitir ordens.'
            },
            answer: 'c',
            explanation: 'A comunicação é a base para criar conexões, compartilhar conhecimento e promover a empatia.'
        },
        {
            id: 'm1-q3',
            question: 'A Língua Brasileira de Sinais (Libras) é classificada como que tipo de comunicação?',
            options: {
                a: 'Verbal escrita.',
                b: 'Verbal oral.',
            ...
            answer: 'd',
            explanation: 'Libras é uma forma de comunicação não-verbal, focada em gestos e expressões corporais/visuais.'
        },
        {
            id: 'm1-q4',
            question: 'Qual o principal objetivo do uso de símbolos na comunicação?',
            options: {
                a: 'Compartilhar ideias, emoções e informações.',
                b: 'Confundir o receptor da mensagem.',
                c: 'Limitar a comunicação a um pequeno grupo.',
                d: 'Apenas para comunicação escrita.'
            },
            answer: 'a',
            explanation: 'A comunicação é o processo de compartilhar ideias, emoções e informações usando símbolos.'
        },
        {
            id: 'm1-q5',
            question: 'Um e-mail de trabalho é um exemplo de qual forma de comunicação?',
            options: {
                a: 'Verbal escrita.',
                b: 'Verbal oral.',
                c: 'Não-verbal visual.',
                d: 'Não-verbal corporal.'
            },
            answer: 'a',
            explanation: 'A comunicação verbal utiliza as formas orais, escritas e digitais, como e-mails.'
        },
        {
            id: 'm1-q6',
            question: 'O que diferencia a comunicação verbal da não-verbal?',
            options: {
                a: 'A verbal usa a voz, a não-verbal usa gestos.',
                b: 'A verbal usa frases coerentes, a não-verbal foca em formas corporais e visuais.',
                c: 'A verbal é formal, a não-verbal é informal.',
                d: 'A verbal é apenas oral, a não-verbal é apenas escrita.'
            },
            answer: 'b',
            explanation: 'A verbal foca na formação de frases com coerência, enquanto a não-verbal dispensa o uso de frases.'
        },
        {
            id: 'm1-q7',
            question: 'Qual dos seguintes é um exemplo de comunicação verbal?',
            options: {
                a: 'Um emoji de "joinha".',
                b: 'Uma placa de "Proibido Fumar".',
                c: 'Uma mensagem de áudio no WhatsApp.',
                d: 'Libras.'
            },
            answer: 'c',
            explanation: 'A comunicação verbal inclui as formas orais, como mensagens de áudio.'
        },
        {
            id: 'm1-q8',
            question: 'Por que a empatia é mencionada no contexto da comunicação?',
            options: {
                a: 'Porque a comunicação serve apenas para expressar quem somos.',
                b: 'Porque a comunicação permite expressar quem somos e compreender o próximo.',
                c: 'Porque a empatia é um tipo de comunicação não-verbal.',
                d: 'Porque a empatia não tem relação com a comunicação.'
            },
            answer: 'b',
            explanation: 'A comunicação é a base para "Expressar quem somos e compreender o próximo, promovendo a empatia."'
        },
        {
            id: 'm1-q9',
            question: 'Gestos e expressões faciais são exemplos de qual tipo de comunicação?',
            options: {
                a: 'Verbal oral.',
                b: 'Verbal digital.',
                c: 'Não-verbal.',
            ...
            answer: 'c',
            explanation: 'A comunicação não-verbal concentra-se em formas corporais (gestos, expressões) e visuais.'
        },
        {
            id: 'm1-q10',
            question: 'O que é comunicação, de acordo com o módulo?',
            options: {
                a: 'Um processo de usar apenas a fala.',
                b: 'Um processo de usar apenas a escrita.',
                c: 'O processo de compartilhar ideias, emoções e informações usando símbolos.',
                d: 'O processo de usar apenas tecnologia digital.'
            },
            answer: 'c',
            explanation: 'É o processo de compartilhar ideias, emoções e informações, usando símbolos como palavras, gestos ou imagens.'
        },
        {
            id: 'm1-q11',
            question: 'A comunicação digital (mensagens de app) se enquadra em qual forma?',
            options: {
                a: 'Verbal.',
                b: 'Não-verbal.',
                c: 'Apenas corporal.',
            ...
            answer: 'a',
            explanation: 'A comunicação verbal utiliza as formas orais, escritas e digitais.'
        },
        {
            id: 'm1-q12',
            question: 'Qual NÃO é um benefício da boa comunicação mencionado?',
            options: {
                a: 'Resolver problemas.',
                b: 'Garantir promoções de trabalho.',
                c: 'Construir laços familiares.',
                d: 'Compartilhar conhecimento.'
            },
            answer: 'b',
            explanation: 'Embora ajude, "garantir promoções" não foi um benefício diretamente listado no texto.'
        }
    ],
  ...
  "module28": [
        {
            id: 'm28-q1',
            question: 'O estudo da *localização* do osso Fêmur na coxa é um exemplo de:',
            options: {
                a: 'Fisiologia',
                b: 'Anatomia',
                c: 'Decúbito',
                d: 'Terminologia Proximal'
            },
            answer: 'b',
            explanation: 'Anatomia é a ciência que estuda a estrutura física e a localização dos órgãos e ossos.'
        },
        {
            id: 'm28-q2',
            question: 'O estudo de *como* o coração bombeia o sangue (sístole/diástole) é um exemplo de:',
            options: {
                a: 'Fisiologia',
                b: 'Anatomia',
                c: 'Decúbito',
                d: 'Terminologia Distal'
            },
            answer: 'a',
            explanation: 'Fisiologia é o estudo do funcionamento dos sistemas, como o bombeamento do sangue.'
        },
        {
            id: 'm28-q3',
            question: 'Qual termo descreve uma pessoa deitada com a barriga para cima?',
            options: {
                a: 'Decúbito Ventral',
                b: 'Decúbito Lateral',
                c: 'Decúbito Dorsal',
            ...
            answer: 'c',
            explanation: 'Decúbito Dorsal é a posição deitado com o dorso (costas) no solo, ou seja, barriga para cima.'
        },
        {
            id: 'm28-q4',
            question: 'Em relação ao cotovelo, o ombro é considerado:',
            options: {
                a: 'Distal',
                b: 'Proximal',
                c: 'Inferior',
            ...
            answer: 'b',
            explanation: 'O ombro está mais próximo à raiz do membro, sendo Proximal em relação ao cotovelo.'
        },
        {
            id: 'm28-q5',
            question: 'Em relação ao joelho, o pé é considerado:',
            options: {
                a: 'Distal',
                b: 'Proximal',
                c: 'Superior',
            ...
            answer: 'a',
            explanation: 'O pé está mais distante da raiz do membro, sendo Distal em relação ao joelho.'
        },
        {
            id: 'm28-q6',
            question: 'O tórax está em uma posição _______ em relação ao abdômen.',
            options: {
                a: 'Inferior',
                b: 'Posterior',
                c: 'Superior',
            ...
            answer: 'c',
            explanation: 'O tórax está mais próximo da cabeça (acima) do que o abdômen, sendo, portanto, Superior.'
        },
        {
            id: 'm28-q7',
            question: 'Qual termo é usado para descrever a frente do corpo?',
            options: {
                a: 'Anterior (Ventral)',
                b: 'Posterior (Dorsal)',
                c: 'Superior',
            ...
            answer: 'a',
            explanation: 'Anterior (ou Ventral) é o termo que descreve a frente do corpo.'
        },
        {
            id: 'm28-q8',
            question: 'Qual termo é usado para descrever a parte de trás do corpo?',
            options: {
                a: 'Anterior (Ventral)',
                b: 'Posterior (Dorsal)',
                c: 'Inferior',
            ...
            answer: 'b',
            explanation: 'Posterior (ou Dorsal) é o termo que descreve a parte de trás do corpo.'
        },
        {
            id: 'm28-q9',
            question: 'Uma pessoa deitada com a barriga para baixo está em qual posição?',
            options: {
                a: 'Decúbito Dorsal',
                b: 'Decúbito Ventral',
                c: 'Decúbito Lateral',
            ...
            answer: 'b',
            explanation: 'Decúbito Ventral é a posição deitado com o ventre (barriga) no solo.'
        },
        {
            id: 'm28-q10',
            question: 'O joelho está em uma posição _______ em relação ao quadril.',
            options: {
                a: 'Superior',
                b: 'Inferior',
                c: 'Proximal',
            ...
            answer: 'b',
            explanation: 'O joelho está mais próximo dos pés (abaixo) do que o quadril, sendo, portanto, Inferior.'
        },
        {
            id: 'm28-q11',
            question: 'Em relação ao ombro, a mão é considerada:',
            options: {
                a: 'Proximal',
                b: 'Distal',
                c: 'Superior',
            ...
            answer: 'b',
            explanation: 'A mão está mais distante da raiz do membro (ombro), sendo Distal.'
        },
        {
            id: 'm28-q12',
            question: 'O termo "Proximal" significa:',
            options: {
                a: 'Mais distante da raiz de um membro.',
                b: 'Mais próximo da raiz de um membro.',
                c: 'Na frente do corpo.',
                d: 'Acima da cabeça.'
            },
            answer: 'b',
            explanation: 'Proximal significa mais próximo à raiz de um membro (ex: o ombro é proximal ao cotovelo).'
        }
    ],
  ...
  "module29": [
        {
            id: 'm29-q1',
            question: 'Qual componente do sangue é responsável pelo transporte de oxigênio?',
            options: {
                a: 'Plaquetas',
                b: 'Leucócitos',
                c: 'Plasma',
            ...
            answer: 'd',
            explanation: 'As Hemácias (glóbulos vermelhos) são responsáveis por transportar oxigênio.'
        },
        {
            id: 'm29-q2',
            ...
            answer: 'a',
            explanation: 'As Plaquetas são responsáveis pela coagulação do sangue.'
        },
        {
            id: 'm29-q3',
            question: 'O movimento de CONTRAÇÃO do coração, quando ele ejeta o sangue, é chamado de:',
            options: {
                a: 'Diástole',
                b: 'Sístole',
                c: 'Hematopoiese',
            ...
            answer: 'b',
            explanation: 'Sístole é o movimento de contração, quando o coração ejeta o sangue.'
        },
        {
            id: 'm29-q4',
            question: 'O crânio, coluna vertebral, costelas e esterno fazem parte de qual esqueleto?',
            options: {
        ...
        {
            id: 'm29-q5',
            question: 'Qual é o maior osso do corpo humano, localizado na coxa?',
            options: {
                a: 'Tíbia',
                b: 'Úmero',
                c: 'Fêmur',
            ...
            answer: 'c',
            explanation: 'O Fêmur, localizado na coxa, é o maior osso do corpo.'
        },
        {
            id: 'm29-q6',
            question: 'O movimento de RELAXAMENTO do coração, quando ele se enche de sangue, é chamado de:',
            options: {
                a: 'Diástole',
                b: 'Sístole',
                c: 'Taquicardia',
            ...
            answer: 'a',
            explanation: 'Diástole é o movimento de dilatação/relaxamento, quando o coração se enche de sangue.'
        },
        {
            id: 'm29-q7',
            question: 'Qual componente do sangue é responsável pela defesa contra infecções?',
            options: {
                a: 'Hemácias',
                b: 'Plaquetas',
                c: 'Leucócitos',
            ...
            answer: 'c',
            explanation: 'Os Leucócitos (glóbulos brancos) são as células de defesa do nosso organismo.'
        },
        {
            id: 'm29-q8',
            question: 'Qual é a principal função do Sistema Esquelético, além da sustentação?',
            options: {
                a: 'Transportar oxigênio.',
                b: 'Regular a temperatura.',
                c: 'Proteger órgãos vitais (como cérebro e coração).',
                d: 'Combater infecções.'
            },
            answer: 'c',
            explanation: 'Uma das funções vitais do esqueleto é a proteção de órgãos, como o crânio protegendo o cérebro e a caixa torácica protegendo o coração.'
        },
        {
            id: 'm29-q9',
            question: 'Os membros superiores (braços) e inferiores (pernas) fazem parte de qual esqueleto?',
            options: {
                a: 'Esqueleto Axial',
                b: 'Esqueleto Central',
            ...
            answer: 'c',
            explanation: 'O Esqueleto Apendicular é composto pelos membros superiores e inferiores.'
        },
        {
            id: 'm29-q10',
            question: 'Quantas vértebras cervicais (região do pescoço) existem na coluna vertebral?',
            options: {
                a: '5',
                b: '12',
                c: '7',
            ...
            answer: 'c',
            explanation: 'A coluna vertebral é dividida em 7 Vértebras Cervicais.'
        },
        {
            id: 'm29-q11',
            question: 'Em uma pressão arterial de 120/80 mmHg, o que o valor 80 representa?',
            options: {
                a: 'Pressão Sistólica (Máxima)',
                b: 'Pressão Diastólica (Mínima)',
                c: 'Frequência Respiratória',
                d: 'Nível de Saturação'
            },
            answer: 'b',
            explanation: 'O valor menor (80) é a Pressão Diastólica (Mínima), quando o coração relaxa.'
        },
        {
            id: 'm29-q12',
            question: 'Qual é o maior órgão do corpo humano e principal barreira de proteção?',
            options: {
                a: 'Fígado',
                b: 'Cérebro',
                c: 'Pele (Sistema Tegumentar)',
                d: 'Coração'
            },
            answer: 'c',
            explanation: 'A pele, parte do Sistema Tegumentar, é o maior órgão do corpo e serve como principal barreira de proteção.'
        }
    ],
  ...
  "module30": [
        {
            id: 'm30-q1',
            question: 'Qual é a primeira e mais eficaz técnica de hemostasia para a maioria das hemorragias externas?',
            options: {
                a: 'Torniquete',
            ...
            answer: 'd',
            explanation: 'A Compressão Direta é a primeira e mais eficaz medida para controlar sangramentos externos.'
        },
        {
            id: 'm30-q2',
            question: 'Em qual tipo de hemorragia o sangue "jorra em pulsos" e tem cor "vermelho vivo"?',
            options: {
                a: 'Arterial',
                b: 'Venosa',
                c: 'Capilar',
            ...
            answer: 'a',
            explanation: 'A hemorragia Arterial, vinda de uma artéria, jorra em pulsos (acompanhando os batimentos) e tem cor vermelho vivo.'
        },
        {
            id: 'm30-q3',
            question: 'O torniquete é indicado para qual situação?',
            options: {
                a: 'Qualquer corte pequeno no braço.',
                b: 'Hemorragias graves e incontroláveis de extremidades.',
                c: 'Sangramento no nariz (exteriorizada).',
                d: 'Hemorragia interna no abdômen.'
            },
            answer: 'b',
            explanation: 'O Torniquete é indicado apenas para hemorragias graves e incontroláveis de extremidades (braços e pernas).'
        },
        {
            id: 'm30-q4',
            question: 'Um choque causado por uma reação alérgica grave (ex: picada de abelha) é classificado como:',
            options: {
            ...
            answer: 'c',
            explanation: 'O Choque Anafilático é causado por uma reação alérgica grave.'
        },
        {
            id: 'm30-q5',
            question: 'Um choque causado pela perda de grande volume de sangue (hemorragia) é classificado como:',
            options: {
                a: 'Choque Hipovolêmico',
            ...
            answer: 'a',
            explanation: 'O Choque Hipovolêmico é causado pela perda de muito sangue ou líquido (hipo = baixo, volemia = volume).'
        },
        {
            id: 'm30-q6',
            question: 'Qual é a informação crucial que DEVE ser registrada ao aplicar um torniquete?',
            options: {
                a: 'O nome da vítima.',
                b: 'O tipo de sangue da vítima.',
                c: 'O horário exato da aplicação.',
                d: 'O nome do socorrista.'
            },
            answer: 'c',
            explanation: 'É fundamental registrar o horário exato em que o torniquete foi aplicado.'
        },
        {
            id: 'm30-q7',
            question: 'Se a gaze aplicada na compressão direta ficar encharcada de sangue, o que se deve fazer?',
            options: {
                a: 'Remover a gaze e aplicar uma nova.',
                b: 'Não remover a gaze encharcada, colocar outra por cima.',
                c: 'Parar a compressão e aplicar um torniquete.',
                d: 'Lavar a gaze e reaplicar.'
            },
            answer: 'b',
            explanation: 'Nunca remova a gaze encharcada, pois isso pode reabrir o ferimento. Coloque uma nova gaze limpa por cima e continue a pressão.'
        },
        {
            id: 'm30-q8',
            question: 'Um choque causado por uma infecção generalizada no sangue é classificado como:',
            options: {
                a: 'Choque Séptico',
            ...
            answer: 'a',
            explanation: 'O Choque Séptico é causado por uma infecção grave e generalizada.'
        },
        {
            id: 'm30-q9',
            question: 'Um sangramento que sai por um orifício natural do corpo (nariz, ouvido) é classificado como hemorragia:',
            options: {
                a: 'Externa',
                b: 'Interna',
                c: 'Exteriorizada',
            ...
            answer: 'c',
            explanation: 'Hemorragia Exteriorizada é aquela que ocorre internamente mas o sangue sai por um orifício natural.'
        },
        {
            id: 'm30-q10',
            question: 'Um choque causado por falha do coração como bomba (ex: infarto) é classificado como:',
            options: {
                a: 'Choque Hipovolêmico',
                b: 'Choque Neurogênico',
            ...
            answer: 'c',
            explanation: 'O Choque Cardiogênico ocorre quando o coração (cardio) falha como bomba.'
        },
        {
            id: 'm30-q11',
            question: 'Qual tipo de hemorragia se caracteriza por um fluxo contínuo (sem pulsos) e sangue vermelho escuro?',
            options: {
                a: 'Capilar',
                b: 'Arterial',
                c: 'Venosa',
            ...
            answer: 'c',
            explanation: 'A hemorragia Venosa (de uma veia) tem fluxo contínuo e cor vermelho escuro.'
        },
        {
            id: 'm30-q12',
            question: 'Um choque causado por uma lesão no sistema nervoso (ex: lesão na medula espinhal) é classificado como:',
            options: {
            ...
            answer: 'b',
            explanation: 'O Choque Neurogênico ocorre por uma falha no sistema nervoso (neuro).'
        }
    ],
  ...
  "module31": [
        {
            id: 'm31-q1',
            question: 'Qual classificação de queimadura forma bolhas, é úmida e causa dor intensa?',
            options: {
                a: '1º Grau',
                b: '2º Grau',
                c: '3º Grau',
            ...
            answer: 'b',
            explanation: 'A queimadura de 2º Grau atinge a derme, forma bolhas, tem aspecto úmido e causa dor intensa.'
        },
        {
            id: 'm31-q2',
            question: 'Qual classificação de queimadura é seca, esbranquiçada ou carbonizada e geralmente indolor?',
            options: {
                a: '1º Grau',
                b: '2º Grau',
                c: '3º Grau',
            ...
            answer: 'c',
            explanation: 'A queimadura de 3º Grau destrói todas as camadas e os nervos, sendo seca, carbonizada e geralmente indolor.'
        },
        {
            id: 'm31-q3',
            question: 'Pela Regra dos 9 em adultos, qual a porcentagem de um braço inteiro?',
            options: {
                a: '18%',
                b: '4,5%',
                c: '9%',
            ...
            answer: 'c',
            explanation: 'Pela Regra dos 9, cada braço (membro superior) corresponde a 9%.'
        },
        {
            id: 'm31-q4',
            question: 'Pela Regra dos 9 em adultos, qual a porcentagem de uma perna inteira?',
            options: {
                a: '18%',
                b: '9%',
                c: '36%',
            ...
            answer: 'a',
            explanation: 'Pela Regra dos 9, cada perna (membro inferior) corresponde a 18%.'
        },
        {
            id: 'm31-q5',
            question: 'Qual a conduta correta para queimadura química por cal viva (pó)?',
            options: {
                a: 'Lavar imediatamente com água corrente.',
                b: 'Aplicar um neutralizante (ácido).',
                c: 'Remover o pó ANTES de lavar com água.',
                d: 'Cobrir com gaze e esperar o hospital.'
            },
            answer: 'c',
            explanation: 'Se for cal viva, deve-se remover o pó antes da lavagem com água, pois a cal reage com a água.'
        },
        {
            id: 'm31-q6',
            question: 'Pelos nasais chamuscados, rouquidão e escarro com fuligem são sinais de alerta para qual condição grave?',
            options: {
                a: 'Queimadura de 3º Grau',
                b: 'Queimadura Elétrica',
                c: 'Lesão por Inalação',
                d: 'Choque Hipovolêmico'
            },
            answer: 'c',
            explanation: 'Pelos nasais chamuscados, rouquidão e escarro com fuligem são sinais de alerta para Lesão por Inalação, que pode fechar as vias aéreas.'
        },
        {
            id: 'm31-q7',
            question: 'Qual é a conduta inicial correta para uma queimadura térmica (calor)?',
            options: {
                a: 'Aplicar pasta de dente ou café.',
                b: 'Resfriar com água corrente por 10-20 minutos.',
                c: 'Estourar todas as bolhas imediatamente.',
                d: 'Aplicar gelo diretamente sobre a lesão.'
            },
            answer: 'b',
            explanation: 'A conduta correta é resfriar o local com água corrente (10-20 min). Nunca aplique produtos caseiros ou estoure bolhas.'
        },
        {
            id: 'm31-q8',
            question: 'Na Regra dos 9, o tronco inteiro (frente e costas) de um adulto corresponde a:',
            options: {
                a: '9%',
                b: '18%',
                c: '36%',
            ...
            answer: 'c',
            explanation: 'O tronco (frente) é 18% e o tronco (costas) é 18%, totalizando 36%.'
        },
        {
            id: 'm31-q9',
            question: 'Qual tipo de queimadura é sempre considerada grave, independente da extensão, e tem alto risco de PCR?',
            options: {
                a: 'Queimadura de 1º Grau (Sol)',
                b: 'Queimadura Elétrica',
                c: 'Queimadura de 2º Grau no braço',
                d: 'Queimadura Térmica por vapor'
            },
            answer: 'b',
            explanation: 'Queimaduras elétricas são sempre graves, pois podem causar lesões internas e arritmias cardíacas (PCR).'
        },
        {
            id: 'm31-q10',
            question: 'Qual a conduta correta para uma queimadura térmica por FRIO (Criolesão)?',
            options: {
                a: 'Massagear a área vigorosamente.',
                b: 'Aplicar água quente ou fogo para aquecer rápido.',
                c: 'Reaquecer gradualmente com água MORNA (37-40°C).',
                d: 'Estourar as bolhas que se formarem.'
            },
            answer: 'c',
            explanation: 'A conduta é reaquecer gradualmente com água MORNA. Não se deve usar água quente nem massagear a área.'
        },
        {
            id: 'm31-q11',
            question: 'Qual a principal diferença entre a queimadura de 1º e 2º grau?',
            options: {
                a: 'A queimadura de 1º grau é indolor.',
                b: 'A queimadura de 2º grau forma bolhas.',
                c: 'A queimadura de 1º grau atinge os ossos.',
                d: 'A queimadura de 2º grau não dói.'
            },
            answer: 'b',
            explanation: 'A característica principal que difere o 2º grau do 1º grau é a formação de bolhas, pois atinge a derme.'
        },
        {
            id: 'm31-q12',
            question: 'Por que a queimadura de 3º grau é geralmente indolor?',
            options: {
                a: 'Porque atinge apenas a epiderme.',
                b: 'Porque forma bolhas que protegem a área.',
                c: 'Porque os nervos da pele foram destruídos.',
                d: 'Porque o cérebro bloqueia a sensação de dor.'
            },
            answer: 'c',
            explanation: 'A queimadura de 3º grau é indolor na área afetada porque destrói todas as camadas da pele, incluindo as terminações nervosas.'
        }
    ],
  ...
  "module32": [
        {
            id: 'm32-q1',
            question: 'Qual é a lesão onde o osso rompe a pele, apresentando grave risco de infecção?',
            options: {
                a: 'Fratura Fechada',
                b: 'Fratura Exposta',
                c: 'Luxação',
            ...
            answer: 'b',
            explanation: 'A Fratura Exposta ocorre quando o osso rompe a pele, com grave risco de infecção e hemorragia.'
        },
        {
            id: 'm32-q2',
            question: 'Qual é a lesão onde o osso sai da sua posição normal na articulação, causando deformidade visível?',
            options: {
                a: 'Fratura Fechada',
                b: 'Distensão',
                c: 'Luxação',
            ...
            answer: 'c',
            explanation: 'A Luxação é quando o osso sai da posição normal da articulação, causando deformidade.'
        },
        {
            id: 'm32-q3',
            question: 'Qual é o "Ponto de Ouro do Socorrista" ao lidar com fraturas e luxações?',
            options: {
                a: 'NUNCA tentar alinhar ou "colocar no lugar".',
                b: 'Sempre tentar alinhar o osso para reduzir a dor.',
                c: 'Aplicar gelo diretamente sobre a fratura exposta.',
                d: 'Testar o movimento da vítima para ver se quebrou.'
            },
            answer: 'a',
            explanation: 'O Ponto de Ouro é NUNCA tentar alinhar, girar ou "colocar no lugar" fraturas ou luxações, pois pode causar lesão de nervos e vasos.'
        },
        {
            id: 'm32-q4',
            question: 'Qual é o protocolo de imobilização correto para uma fratura no meio da perna (Tíbia)?',
            options: {
                a: 'Imobilizar apenas o tornozelo.',
                b: 'Imobilizar apenas o joelho.',
                c: 'Imobilizar a articulação acima (joelho) e abaixo (tornozelo).',
                d: 'Não imobilizar, apenas elevar.'
            },
            answer: 'c',
            explanation: 'O protocolo correto é imobilizar a articulação acima e abaixo da lesão.'
        },
        {
            id: 'm32-q5',
            question: 'O que significa avaliar o "PMS" antes e depois da imobilização?',
            options: {
                a: 'Pressão, Músculo, Sangramento',
                b: 'Pulso, Movimento, Sensibilidade',
                c: 'Paciente, Membro, Sangue',
                d: 'Pele, Mão, Sapato'
            },
            answer: 'b',
            explanation: 'PMS significa avaliar Pulso, Movimento e Sensibilidade da extremidade do membro.'
        },
        {
            id: 'm32-q6',
            question: 'Qual lesão é uma torção de articulação (como o tornozelo) que afeta os ligamentos?',
            options: {
                a: 'Entorse',
                b: 'Luxação',
                c: 'Distensão',
            ...
            answer: 'a',
            explanation: 'A Entorse é a torção de uma articulação que estira ou rompe os ligamentos.'
        },
        {
            id: 'm32-q7',
            question: 'Qual é a conduta correta para uma Fratura Exposta?',
            options: {
                a: 'Tentar empurrar o osso para dentro e limpar.',
                b: 'Lavar com água e sabão.',
                c: 'Cobrir com gaze estéril e controlar a hemorragia.',
                d: 'Aplicar compressa morna.'
            },
            answer: 'c',
            explanation: 'Deve-se controlar a hemorragia e cobrir a fratura exposta com gaze estéril, sem tentar colocar o osso no lugar.'
        },
        {
            id: 'm32-q8',
            question: 'O som ou sensação de ossos raspando em uma fratura é chamado de:',
            options: {
                a: 'Crepitação',
                b: 'Luxação',
                c: 'Deformidade',
            ...
            answer: 'a',
            explanation: 'Crepitação é o estalido ou sensação de ossos raspando em uma fratura.'
        },
        {
            id: 'm32-q9',
            question: 'Qual é a conduta correta para uma Luxação?',
            options: {
                a: 'Tentar reduzir (colocar no lugar) imediatamente.',
                b: 'Imobilizar na posição encontrada e aplicar frio.',
                c: 'Pedir para a vítima forçar o movimento.',
                d: 'Aplicar compressas mornas.'
            },
            answer: 'b',
            explanation: 'NÃO se deve tentar reduzir. A conduta é imobilizar na posição encontrada e aplicar compressa fria (com pano).'
        },
        {
            id: 'm32-q10',
            question: 'O alongamento excessivo que causa microlesões em músculos e tendões (ex: "puxar" a lombar) é chamado de:',
            options: {
                a: 'Fratura',
                b: 'Luxação',
                c: 'Entorse',
                d: 'Distensão / Estiramento'
            },
            answer: 'd',
            explanation: 'A Distensão ou Estiramento é o alongamento excessivo de músculos e tendões.'
        },
        {
            id: 'm32-q11',
            question: 'O protocolo RICE (Repouso, Gelo, Compressão, Elevação) é mais indicado para qual lesão?',
            options: {
                a: 'Fratura Exposta',
                b: 'Luxação',
                c: 'Entorse',
                d: 'Fratura Fechada Grave'
            },
            answer: 'c',
            explanation: 'O protocolo RICE é a conduta clássica para Entorses (lesão de ligamentos).'
        },
        {
            id: 'm32-q12',
            question: 'Quando o socorrista deve avaliar o PMS (Pulso, Movimento, Sensibilidade)?',
            options: {
                a: 'Apenas antes de imobilizar.',
                b: 'Apenas depois de imobilizar.',
                c: 'Antes e Depois de imobilizar.',
                d: 'Apenas se a vítima gritar de dor.'
            },
            answer: 'c',
            explanation: 'O PMS deve ser avaliado antes da imobilização (para saber o estado inicial) e depois (para garantir que a imobilização não piorou a circulação).'
        }
    ],
  ...
  "module34": [
        {
            id: 'm34-q1',
            question: 'Qual é o valor de referência normal para a Frequência Cardíaca (Pulso) em adultos em repouso?',
            options: {
                a: '40 a 60 bpm',
                b: '60 a 100 bpm',
                c: '100 a 120 bpm',
            ...
            answer: 'b',
            explanation: 'O valor de referência para o Pulso (FC) em adultos é de 60 a 100 batimentos por minuto (bpm).'
        },
        {
            id: 'm34-q2',
            question: 'Qual é o valor de referência normal para a Frequência Respiratória (FR) em adultos em repouso?',
            options: {
                a: '5 a 10 mpm',
                b: '12 a 20 mpm',
                c: '25 a 30 mpm',
            ...
            answer: 'b',
            explanation: 'O valor de referência para a Frequência Respiratória (FR) em adultos é de 12 a 20 movimentos por minuto (mpm).'
        },
        {
            id: 'm34-q3',
            question: 'Uma frequência cardíaca acima de 100 bpm em um adulto é chamada de:',
            options: {
                a: 'Bradicardia',
                b: 'Taquicardia',
                c: 'Bradipneia',
            ...
            answer: 'b',
            explanation: 'Taquicardia é o pulso (frequência cardíaca) acima de 100 bpm.'
        },
        {
            id: 'm34-q4',
            question: 'Uma frequência respiratória abaixo de 12 mpm em um adulto é chamada de:',
            options: {
                a: 'Bradicardia',
                b: 'Taquicardia',
                c: 'Bradipneia',
            ...
            answer: 'c',
            explanation: 'Bradipneia é a frequência respiratória (FR) abaixo do normal.'
        },
        {
            id: 'm34-q5',
            question: 'Em uma pressão arterial de 120/80 mmHg, o que o valor 120 representa?',
            options: {
                a: 'Pressão Diastólica (Mínima)',
                b: 'Pressão Sistólica (Máxima)',
                c: 'Frequência Cardíaca',
                d: 'Temperatura Corporal'
            },
            answer: 'b',
            explanation: 'O valor maior (120) é a Pressão Sistólica (Máxima), quando o coração se contrai.'
        },
        {
            id: 'm34-q6',
            question: 'Em uma pressão arterial de 120/80 mmHg, o que o valor 80 representa?',
        ...
        {
            id: 'm34-q7',
            question: 'Qual local é mais utilizado para verificar o pulso em uma vítima em emergência (inconsciente)?',
            options: {
                a: 'Artéria Radial (punho)',
                b: 'Artéria Carótida (pescoço)',
                c: 'Artéria Femoral (virilha)',
                d: 'Artéria Pedial (pé)'
            },
            answer: 'b',
            explanation: 'Em emergências ou vítimas inconscientes, dá-se preferência ao pulso central, sendo a Artéria Carótida (pescoço) a mais utilizada.'
        },
        {
            id: 'm34-q8',
            question: 'Uma frequência respiratória acima de 20 mpm em um adulto é chamada de:',
            options: {
                a: 'Bradicardia',
                b: 'Taquicardia',
                c: 'Bradipneia',
            ...
            answer: 'd',
            explanation: 'Taquipneia é a frequência respiratória (FR) acima do normal.'
        },
        {
            id: 'm34-q9',
            question: 'Uma frequência cardíaca abaixo de 60 bpm em um adulto é chamada de:',
            options: {
                a: 'Bradicardia',
                b: 'Taquicardia',
                c: 'Bradipneia',
            ...
            answer: 'a',
            explanation: 'Bradicardia é o pulso (frequência cardíaca) abaixo de 60 bpm.'
        },
        {
            id: 'm34-q10',
            question: 'Qual é a temperatura corporal (axilar) considerada normal para um adulto?',
            options: {
                a: '34°C a 35°C',
                b: '35°C a 36°C',
                c: '36°C a 37,5°C',
            ...
            answer: 'c',
            explanation: 'A temperatura axilar normal varia de 36°C a 37,5°C.'
        },
        {
            id: 'm34-q11',
            ...
            answer: 'd',
            explanation: 'Uma temperatura de 35°C ou menos é classificada como Hipotermia.'
        },
        {
            id: 'm34-q12',
            question: 'Como deve ser contada a Frequência Respiratória (FR)?',
            options: {
                a: 'Contando 1 inspiração + 1 expiração como um movimento.',
                b: 'Contando apenas as inspirações.',
                c: 'Contando apenas as expirações.',
                d: 'Perguntando ao paciente como ele se sente.'
            },
            answer: 'a',
            explanation: 'A FR é contada em movimentos por minuto (mpm), onde cada movimento é composto por 1 inspiração + 1 expiração.'
        }
    ],
  ...
  "module37": [
        {
            id: 'm37-q1',
            question: 'Quais são os 3 sinais principais de uma Parada Cardiorrespiratória (PCR)?',
            options: {
                a: 'Dor no peito, suor frio e palidez.',
                b: 'Vítima falando, tossindo e respirando rápido.',
                c: 'Inconsciência, Ausência de respiração (ou Gasping) e Ausência de pulso central.',
                d: 'Febre alta, convulsão e sangramento.'
            },
            answer: 'c',
            explanation: 'Os sinais de PCR são: Inconsciência (não responde), Ausência de respiração (ou Gasping) e Ausência de pulso central (em até 10s).'
        },
        {
            id: 'm37-q2',
            question: 'Qual é a frequência (velocidade) correta das compressões torácicas em uma RCP de alta qualidade?',
            options: {
                a: '60 a 80 compressões/min',
                b: '80 a 100 compressões/min',
                c: '100 a 120 compressões/min',
                d: '130 a 150 compressões/min'
            },
            answer: 'c',
            explanation: 'A frequência oficial para uma RCP de alta qualidade é de 100 a 120 compressões por minuto.'
        },
        {
            id: 'm37-q3',
            question: 'Qual é a profundidade correta das compressões em um ADULTO?',
            options: {
                a: '1 a 2 cm',
                b: '3 a 4 cm',
                c: '5 a 6 cm',
            ...
            answer: 'c',
            explanation: 'A profundidade correta para adultos é de 5 a 6 cm.'
        },
        {
            id: 'm37-q4',
            question: 'Qual a relação compressão:ventilação correta para 2 socorristas em uma CRIANÇA?',
            options: {
                a: '30:2',
                b: '15:2',
                c: '15:1',
            ...
            answer: 'b',
            explanation: 'Para 2 socorristas em Crianças (ou Lactentes), a relação muda para 15 compressões e 2 ventilações (15:2).'
        },
        {
            id: 'm37-q5',
            question: 'Qual cuidado especial deve ser tomado ao realizar RCP em uma GESTANTE?',
            options: {
                a: 'Fazer compressões mais leves (3-4 cm).',
                b: 'Fazer apenas ventilações.',
                c: 'Não usar o DEA.',
                d: 'Deslocar o útero para a esquerda.'
            },
            answer: 'd',
            explanation: 'Em gestantes, deve-se realizar o deslocamento do útero para a esquerda para aliviar a compressão da veia cava.'
        },
        {
            id: 'm37-q6',
            question: 'O que é "Gasping"?',
            options: {
                a: 'Respiração normal e profunda.',
                b: 'Respiração agônica (ineficaz), sinal de PCR.',
                c: 'Tosse com secreção.',
                d: 'Ausência total de respiração (Apneia).'
            },
            answer: 'b',
            explanation: 'Gasping é a respiração agônica (involuntária), um sinal de PCR. Não é uma respiração eficaz.'
        },
        {
            id: 'm37-q7',
            question: 'Qual é o primeiro elo da Cadeia de Sobrevivência?',
            options: {
                a: 'RCP precoce.',
                b: 'Desfibrilação precoce (DEA).',
                c: 'Reconhecimento precoce + acionar 192/193.',
                d: 'Suporte Avançado (SAV).'
            },
            answer: 'c',
            explanation: 'O primeiro elo é o Reconhecimento precoce da PCR e o acionamento do serviço de emergência (192/193).'
        },
        {
            id: 'm37-q8',
            question: 'Por que é importante permitir o "retorno total do tórax" entre as compressões?',
            options: {
                a: 'Para o socorrista descansar o braço.',
                b: 'Para permitir que o coração se encha de sangue.',
                c: 'Para evitar fraturar as costelas.',
                d: 'Para facilitar a contagem da frequência.'
            },
            answer: 'b',
            explanation: 'Permitir o retorno total do tórax é vital para que o coração possa se encher de sangue (diástole) antes da próxima compressão.'
        },
        {
            id: 'm37-q9',
            question: 'Qual é a situação em que o socorrista NÃO deve iniciar a RCP?',
            options: {
                a: 'A vítima está cianótica (roxa).',
                b: 'A vítima está em "Gasping".',
                c: 'A vítima apresenta "Rigor Mortis" (rigidez).',
                d: 'A vítima é um idoso.'
            },
            answer: 'c',
            explanation: 'Não se inicia RCP em casos de sinais evidentes de morte, como Rigor Mortis, decomposição ou decapitação.'
        },
        {
            id: 'm37-q10',
            question: 'Qual a relação compressão:ventilação para 1 socorrista em um LACTENTE (bebê)?',
            options: {
                a: '30:2',
                b: '15:2',
                c: '15:1',
            ...
            answer: 'a',
            explanation: 'Quando há apenas 1 socorrista, a relação é sempre 30:2, independente da idade (adulto, criança ou lactente).'
        },
        {
            id: 'm37-q11',
            question: 'Em uma RCP de alta qualidade, a troca de socorrista (que está comprimindo) deve ser feita a cada:',
            options: {
                a: '30 segundos.',
                b: '1 minuto.',
                c: '2 minutos.',
                d: 'Apenas quando o socorrista pedir.'
            },
            answer: 'c',
            explanation: 'A troca deve ser feita a cada 2 minutos para evitar a exaustão e manter a qualidade das compressões.'
        },
        {
            id: 'm37-q12',
            question: 'Qual a profundidade correta das compressões em um LACTENTE (bebê)?',
            options: {
                a: 'Aprox. 4 cm (ou 1/3 do tórax)',
                b: '5 a 6 cm',
                c: '1 a 2 cm',
                d: 'O máximo possível.'
            },
            answer: 'a',
            explanation: 'A profundidade para lactentes é de aproximadamente 4 cm, o que corresponde a 1/3 da profundidade do tórax.'
        }
    ],
  ...
  // --- QUESTÕES DO MÓDULO SP 1: LEGISLAÇÃO APLICADA (10 Questões) ---
    "sp_module1": [
        { id: 'sp-m1-q1', question: 'Segundo o Art. 5º da CF, a casa é asilo inviolável. Qual a única exceção para entrada SEM consentimento durante a NOITE?', options: { a: 'Determinação judicial.', b: 'Em caso de flagrante delito, desastre ou para prestar socorro.', c: 'Ordem do delegado.', d: 'Suspeita de crime.' }, answer: 'b', explanation: 'À noite, a constituição só permite entrada em caso de flagrante, desastre ou socorro. Determinação judicial apenas durante o dia.' },
        { id: 'sp-m1-q2', question: 'Quem tem o DEVER de efetuar a prisão em flagrante delito?', options: { a: 'Qualquer do povo.', b: 'Apenas a Polícia Civil.', c: 'As autoridades policiais e seus agentes.', d: 'Apenas Juízes.' }, answer: 'c', explanation: 'Para a autoridade policial é um DEVER; para qualquer pessoa do povo é uma FACULDADE (pode ou não).' },
        { id: 'sp-m1-q3', question: 'O que caracteriza o Crime Doloso?', options: { a: 'Falta de atenção do agente.', b: 'Imperícia técnica.', c: 'Quando o agente quer o resultado ou assume o risco de produzi-lo.', d: 'Quando o crime não se consuma por vontade alheia.' }, answer: 'c', explanation: 'Dolo é a vontade livre e consciente de praticar o crime ou a assunção do risco (dolo eventual).' },
        { id: 'sp-m1-q4', question: 'Na Legítima Defesa, o que significa usar os "meios necessários"?', options: { a: 'Usar sempre arma de fogo.', b: 'Usar os meios que o agente tem à sua disposição no momento para repelir a agressão.', c: 'Usar apenas defesa corporal.', d: 'Chamar ajuda de terceiros.' }, answer: 'b', explanation: 'Meios necessários são os recursos disponíveis no momento da agressão para a defesa.' },
        { id: 'sp-m1-q5', question: 'Qual a diferença entre Interceptação e Quebra de Sigilo Telefônico?', options: { a: 'Não há diferença.', b: 'Interceptação grava o conteúdo da conversa; Quebra de Sigilo acessa apenas o histórico de dados.', c: 'Quebra de sigilo ouve a conversa.', d: 'Interceptação é apenas para dados.' }, answer: 'b', explanation: 'Interceptação refere-se à escuta/gravação do áudio; Quebra de sigilo refere-se aos registros (quem ligou, hora, duração).' },
        { id: 'sp-m1-q6', question: 'O Art. 5º da Constituição garante inviolabilidade de cinco direitos fundamentais. Quais são?', options: { a: 'Apenas vida e liberdade.', b: 'Vida, Liberdade, Igualdade, Segurança e Propriedade.', c: 'Apenas propriedade privada.', d: 'Trabalho, Lazer e Segurança.' }, answer: 'b', explanation: 'Conforme o caput do Art. 5º: Vida, Liberdade, Igualdade, Segurança e Propriedade.' },
        { id: 'sp-m1-q7', question: 'Crime Tentado é aquele que:', options: { a: 'O agente desiste voluntariamente.', b: 'Reúne todos os elementos da definição legal.', c: 'Iniciada a execução, não se consuma por circunstâncias alheias à vontade do agente.', d: 'Ocorre por negligência ou imprudência.' }, answer: 'c', explanation: 'A definição exata de tentativa é a não consumação por fatores externos à vontade do agente.' },
        { id: 'sp-m1-q8', question: 'Em qual destas situações NÃO há crime (Exclusão de Ilicitude - Art 23)?', options: { a: 'Homicídio passional.', b: 'Estrito cumprimento do dever legal.', c: 'Furto famélico sem perigo.', d: 'Roubo qualificado.' }, answer: 'b', explanation: 'O Código Penal (Art 23) exclui o crime em: estrito cumprimento de dever legal, legítima defesa ou estado de necessidade.' },
        { id: 'sp-m1-q9', question: 'O Princípio da Presunção de Inocência afirma que:', options: { a: 'Todos são culpados até provar o contrário.', b: 'A prisão pode ocorrer por simples suspeita.', c: 'Ninguém será considerado culpado até o trânsito em julgado de sentença penal condenatória.', d: 'O réu deve provar sua inocência imediatamente.' }, answer: 'c', explanation: 'Ninguém é considerado culpado antes da sentença final irrecorrível (trânsito em julgado).' },
        { id: 'sp-m1-q10', question: 'A liberdade de locomoção no território nacional é garantida:', options: { a: 'Apenas para brasileiros natos.', b: 'Livremente em tempo de paz, nos termos da lei.', c: 'A qualquer momento, mesmo em estado de sítio.', d: 'Apenas para quem paga impostos.' }, answer: 'b', explanation: 'É livre a locomoção em tempo de paz (Art 5º, XV), podendo entrar e sair com seus bens.' }
    ],

    // --- QUESTÕES DO MÓDULO SP 2: NOÇÕES DE VIGILÂNCIA (10 Questões) ---
    "sp_module2": [
        { id: 'sp-m2-q1', question: 'Qual a característica do perfil "Proativo"?', options: { a: 'Esperar a ordem do chefe para agir.', b: 'Agir apenas após o crime acontecer.', c: 'Antecipar-se ao problema para evitar que situações simples se tornem críticas.', d: 'Usar a força física imediatamente.' }, answer: 'c', explanation: 'Proatividade é a capacidade de agir antecipadamente, prevendo necessidades.' },
        { id: 'sp-m2-q2', question: 'Onde são realizadas as Rondas Periféricas?', options: { a: 'Dentro do escritório da administração.', b: 'No estacionamento de veículos.', c: 'Próximas às barreiras limítrofes (muros, cercas, grades).', d: 'Fora da empresa, na rua pública.' }, answer: 'c', explanation: 'Periférica refere-se ao perímetro, ou seja, os limites físicos da instalação.' },
        { id: 'sp-m2-q3', question: 'O que é a "Passagem de Serviço"?', options: { a: 'Ir embora sem avisar ninguém.', b: 'O ato de um vigilante substituir outro, conferindo materiais, armas e ocorrências.', c: 'Passar o problema para o supervisor resolver.', d: 'Entregar o crachá na portaria.' }, answer: 'b', explanation: 'É o momento crucial da troca de turno onde se verifica a integridade de equipamentos e armamento.' },
        { id: 'sp-m2-q4', question: 'Em relação ao sigilo profissional, o segurança NÃO deve:', options: { a: 'Informar ocorrências graves ao supervisor.', b: 'Comentar horários de diretores, valores de numerários e efetivos com estranhos.', c: 'Relatar falhas de segurança no livro.', d: 'Manter a discrição.' }, answer: 'b', explanation: 'O vazamento de informações sensíveis (horários, valores) compromete a segurança.' },
        { id: 'sp-m2-q5', question: 'A segurança patrimonial em eventos sociais é obrigatória para público superior a:', options: { a: '500 pessoas.', b: '1.000 pessoas.', c: '3.000 pessoas.', d: '5.000 pessoas.' }, answer: 'c', explanation: 'Conforme Portaria 3.233/12, eventos acima de 3.000 pessoas exigem segurança privada específica.' },
        { id: 'sp-m2-q6', question: 'Qual o foco principal da atuação do segurança em Shopping Centers?', options: { a: 'Abordagem ostensiva e agressiva.', b: 'Discrição, prevenção de furtos e controle de incidentes comportamentais.', c: 'Revista pessoal em todos os clientes na entrada.', d: 'Uso de armas longas nos corredores.' }, answer: 'b', explanation: 'Por ser ambiente de lazer, a segurança deve ser discreta para não constranger os clientes.' },
        { id: 'sp-m2-q7', question: 'Muros, grades, portões e iluminação são classificados como que tipo de recurso?', options: { a: 'Recursos Humanos.', b: 'Recursos Técnicos.', c: 'Recursos Arquitetônicos.', d: 'Recursos Tecnológicos.' }, answer: 'c', explanation: 'São barreiras físicas passivas e estáticas, integradas à arquitetura do local.' },
        { id: 'sp-m2-q8', question: 'Qual a diferença recomendada entre Rondas Diurnas e Noturnas?', options: { a: 'Não há diferença.', b: 'Diurna deve ser ostensiva (visível); Noturna deve evitar exposição (oculta).', c: 'Noturna deve usar sirenes e luzes.', d: 'Diurna deve ser feita sentado.' }, answer: 'b', explanation: 'De dia mostra-se presença para inibir; à noite preserva-se a integridade evitando ser alvo fácil.' },
        { id: 'sp-m2-q9', question: 'O que significa o segurança estar em "Estado de Alerta"?', options: { a: 'Ficar nervoso e tenso.', b: 'Ter medo constante.', c: 'Manter inspeção visual constante e não menosprezar riscos.', d: 'Dormir no posto com um olho aberto.' }, answer: 'c', explanation: 'É a postura mental de atenção permanente ao ambiente e pessoas ao redor.' },
        { id: 'sp-m2-q10', question: 'Em hospitais, qual a recomendação em caso de perturbação da ordem grave?', options: { a: 'Entrar em luta corporal imediata.', b: 'Chamar a guarda municipal ou polícia militar para evitar confronto direto.', c: 'Ignorar a situação.', d: 'Expulsar o paciente doente.' }, answer: 'b', explanation: 'Para evitar riscos em ambiente sensível, deve-se acionar o apoio policial quando o conflito escala.' }
    ],

    // --- QUESTÕES DO MÓDULO SP 3: USO PROGRESSIVO DA FORÇA (10 Questões) ---
    "sp_module3": [
        { id: 'sp-m3-q1', question: 'Qual é o Nível 1 do uso da força?', options: { a: 'Verbalização.', b: 'Uso de Cassetete.', c: 'Presença Física.', d: 'Tiro de advertência.' }, answer: 'c', explanation: 'A simples presença do segurança uniformizado já é o primeiro nível de força/dissuasão.' },
        { id: 'sp-m3-q2', question: 'Quais são os três fatores do Triângulo da Força Letal?', options: { a: 'Raiva, Medo e Reação.', b: 'Habilidade, Oportunidade e Risco.', c: 'Arma, Munição e Alvo.', d: 'Legalidade, Moralidade e Ética.' }, answer: 'b', explanation: 'Para uso letal, deve haver Habilidade (capacidade), Oportunidade (alcance) e Risco (perigo iminente).' },
        { id: 'sp-m3-q3', question: 'O Princípio da Proporcionalidade determina que:', options: { a: 'Deve-se usar sempre força máxima.', b: 'O nível de força deve ser compatível com a gravidade da ameaça.', c: 'Deve-se revidar na mesma moeda (olho por olho).', d: 'O uso da força é ilimitado se o bandido estiver armado.' }, answer: 'b', explanation: 'A resposta deve ser proporcional e moderada em relação à agressão sofrida.' },
        { id: 'sp-m3-q4', question: 'Quando é justificado usar a Força Letal (Nível 6)?', options: { a: 'Para evitar fuga de furto simples.', b: 'Quando alguém xinga o segurança.', c: 'Em último caso, para deter ameaça mortal ou lesão grave iminente.', d: 'Sempre que o suspeito correr.' }, answer: 'c', explanation: 'Força letal é a ultima ratio (último recurso), usada apenas para preservar a vida.' },
        { id: 'sp-m3-q5', question: 'O que caracteriza o Nível 2 (Verbalização)?', options: { a: 'Gritar palavrões para assustar.', b: 'Uso de habilidades de comunicação e autoridade para controlar a situação.', c: 'Conversar sobre assuntos aleatórios.', d: 'Negociar suborno.' }, answer: 'b', explanation: 'É o uso da voz e comandos verbais claros, capitalizando a autoridade do uniforme.' },
        { id: 'sp-m3-q6', question: 'Técnicas de submissão, agentes químicos e cães pertencem a qual nível?', options: { a: 'Nível 1.', b: 'Nível 2.', c: 'Nível 4 (Controle Físico/Submissão).', d: 'Nível 6.' }, answer: 'c', explanation: 'Nível 4 visa superar resistência ativa usando técnicas mais enérgicas ou químicos.' },
        { id: 'sp-m3-q7', question: 'O Princípio da Conveniência estabelece que:', options: { a: 'Deve-se agir se for conveniente para o segurança pessoalmente.', b: 'A força não deve ser empregada se ocasionar danos maiores que os objetivos legais pretendidos.', c: 'Sempre é conveniente prender.', d: 'O segurança escolhe a lei que quer seguir.' }, answer: 'b', explanation: 'Analisa o custo-benefício da intervenção (ex: não iniciar tiroteio em multidão para parar furto simples).' },
        { id: 'sp-m3-q8', question: 'No triângulo da força, o que define a "Oportunidade"?', options: { a: 'O momento certo de atacar.', b: 'O potencial de usar a habilidade (ex: estar ao alcance/distância correta).', c: 'A chance de fugir.', d: 'Ter uma arma guardada em casa longe do local.' }, answer: 'b', explanation: 'Não há oportunidade se o agressor, mesmo armado com faca, está a 100m de distância atrás de uma grade.' },
        { id: 'sp-m3-q9', question: 'O uso de arma de fogo para controle intimatório (apontar sem atirar) está em qual nível?', options: { a: 'Nível 1.', b: 'Nível 3.', c: 'Nível 5 (Táticas defensivas não letais/dissuasivas).', d: 'Nível 6.' }, answer: 'c', explanation: 'O material classifica o uso intimatório (sem disparo) como tática defensiva (Nível 5), passo anterior ao letal.' },
        { id: 'sp-m3-q10', question: 'Qual é o objetivo principal do uso da força na segurança?', options: { a: 'Punir o criminoso.', b: 'Fazer justiça com as próprias mãos.', c: 'Impedir pessoas de contrariar normas ou a lei (intervenção/defesa).', d: 'Demonstrar poder e superioridade.' }, answer: 'c', explanation: 'O objetivo é a interrupção da conduta ilícita e proteção, jamais a punição.' }
    ],

    // --- QUESTÕES DO MÓDULO SP 4: PRIMEIROS SOCORROS (10 Questões) ---
    "sp_module4": [
        { id: 'sp-m4-q1', question: 'Qual a proporção correta de compressões e ventilações na RCP (Adulto/Criança/Lactente) no SBV?', options: { a: '15 compressões, 2 ventilações.', b: '30 compressões, 2 ventilações.', c: '60 compressões, 4 ventilações.', d: 'Apenas ventilações.' }, answer: 'b', explanation: 'Protocolo padrão universal apresentado no material é de 30 compressões para 2 ventilações (30x2).' },
        ...
        { id: 'sp-m4-q9', question: 'Na técnica de hemostasia, o que é a Compressão Indireta?', options: { a: 'Pressionar o ferimento.', b: 'Comprimir o vaso (artéria) em um ponto acima do ferimento.', c: 'Elevar o braço.', d: 'Colocar gelo.' }, answer: 'b', explanation: 'Bloqueia o fluxo sanguíneo pressionando a artéria principal contra o osso antes que o sangue chegue à ferida.' },
        { id: 'sp-m4-q10', question: 'O Torniquete é indicado preferencialmente em quais casos?', options: { a: 'Cortes superficiais.', b: 'Sangramento nasal.', c: 'Amputações traumáticas e esmagamentos de membros.', d: 'Ferimentos na cabeça.' }, answer: 'c', explanation: 'É um recurso de última instância para hemorragias massivas em extremidades.' }
    ]
